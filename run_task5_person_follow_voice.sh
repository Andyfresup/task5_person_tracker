...
YOLO_PERCEPTION_DIR="${YOLO_PERCEPTION_DIR:-$SCRIPT_DIR/../26-WrightEagle.AI-YOLO-Perception}"
TABLE_FOOD_CHECK_ENABLED="${TABLE_FOOD_CHECK_ENABLED:-true}"
TABLE_FOOD_CHECK_DELAY="${TABLE_FOOD_CHECK_DELAY:-1.0}"
TABLE_FOOD_DETECT_COMMAND="${TABLE_FOOD_DETECT_COMMAND:-}"
TABLE_FOOD_DETECT_USE_SHELL="${TABLE_FOOD_DETECT_USE_SHELL:-false}"
TABLE_FOOD_DETECT_TIMEOUT="${TABLE_FOOD_DETECT_TIMEOUT:-8.0}"
TABLE_FOOD_DETECTION_JSON_FILE="${TABLE_FOOD_DETECTION_JSON_FILE:-$YOLO_PERCEPTION_DIR/detections.json}"
